package model_support::model_supportClient;
...
model_support::model_supportClient
...
sub new
{
    ...
    my $self = {
	client => model_support::model_supportClient::RpcClient->new,
	url => $url,
	headers => [],
    };
...
<pre>
$workspace_name is a model_support.workspace_name
$contigset_id is a model_support.contigset_id
$return is a model_support.CountContigsResults
...
# Authentication: required
	...
	method => "model_support.count_contigs",
	params => \@args,
    });
    if ($result) {
	if ($result->is_error) {
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for model_support::model_supportClient\n";
    }
    if ($sMajor == 0) {
        warn "model_support::model_supportClient version is $svr_version. API subject to change.\n";
    }
}
...
package model_support::model_supportClient::RpcClient;
